# Install script for directory: /home/anigomez/work/openMVS/apps/InterfaceCOLMAP
...
file(INSTALL DESTINATION "/usr/local/bin/OpenMVS" TYPE EXECUTABLE FILES "/home/anigomez/work/openMVS/build/bin/InterfaceCOLMAP")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/OpenMVS/InterfaceCOLMAP" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/OpenMVS/InterfaceCOLMAP")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/OpenMVS/InterfaceCOLMAP"
